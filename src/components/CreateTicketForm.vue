<template>
  <form @submit.prevent="handleCreateTicket">
    <input v-model="title" placeholder="Title" required class="form-control mb-2"/>
    <input v-model="description" placeholder="Description" required class="form-control mb-2"/>
    <input v-model="category" placeholder="Category" required class="form-control mb-2"/>
